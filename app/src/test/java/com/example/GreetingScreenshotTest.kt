...
import com.example.ui.screens.MainPrayerCounterScreen
...
class GreetingScreenshotTest {
  ...
  fun prayer_counter_screenshot() {
    ...
    viewModel.setBaseCumulativeCount(500)
    viewModel.updateTargetCount(1000)

    composeTestRule.setContent {
      MyApplicationTheme {
        MainPrayerCounterScreen(viewModel = viewModel)
      }
    }
